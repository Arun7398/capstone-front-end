...
function Login() {
  ...
  let formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        let loginReq = await axios.post(`${API}/auth/login`, values);
        window.localStorage.setItem("app-token", loginReq.data.token);
        window.localStorage.setItem("name", loginReq.data.name);
    ...
    <div className="container-fluid mr-0 pr-0 body">
      <div className="row m-0 ">
        <div className="col-md-8">
          ...
          <div className="row">
            <div className="col-md-12 d-flex flex-column justify-content-center align-items-center">
              <div className="col-md-6 login-input border-0">
        ...
        <div className="col-md-4 text-right pr-0">
          <img
            src="https://images.pexels.com/photos/4065877/pexels-photo-4065877.jpeg?auto=compress&cs=tinysrgb&w=600"
            alt=""
            className="img-class"
          />
        </div>
